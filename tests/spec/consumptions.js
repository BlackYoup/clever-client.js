module.exports = function(client, displayError){
  ...
  describe("Consumptions", function(){
    it("should get consumptions for the user", function(done){
      ...
      req.onValue(function(consumptions){
        expect(consumptions[userAppId]["2015-01-07T00:00:00.000Z"]).toBe(40);
        done();
      });
    ...
    it("should get consumptions for the given organisation", function(done){
      ...
      req.onValue(function(consumptions){
        expect(consumptions[orgaAppId]["2014-05-18T00:00:00.000Z"]).toBe(0);
        done();
      });
    ...
    it("should get consumptions for a specific user application", function(done){
      ...
      req.onValue(function(consumptions){
        expect(consumptions["2015-01-07T00:00:00.000Z"]).toBe(40);
        done();
      });
    ...
    it("should get consumptions for a specific organisation application", function(done){
      ...
      req.onValue(function(consumptions){
        expect(consumptions["2014-05-18T00:00:00.000Z"]).toBe(0);
        done();
      });
